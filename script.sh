...
--peft_model army-fm-sft-checkpoints/checkpoint-1400 \
--output_dir army-fm-sft-checkpoints/checkpoint-1400

python merge_peft_model.py \
--peft_model army-fm-sft-checkpoints/checkpoint-2200 \
--output_dir army-fm-sft-checkpoints/checkpoint-2200

python merge_peft_model.py \
--peft_model army-fm-sft-checkpoints/checkpoint-2379 \
